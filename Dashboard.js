...
import { GoalStatus, TaskStatus } from './types.js';

const Dashboard = ({ lifePlan, goals, tasks, onNavigate, onUpdateTask }) => {
  ...
  const getGoalTitle = (goalId) => goals.find(g => g.id === goalId)?.title || 'Sin Meta';
